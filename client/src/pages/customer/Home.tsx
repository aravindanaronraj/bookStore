...
const heroDefaults: SiteContent["hero"] = { badge: "Curated books for every reader", heading: "Stories that stay with you.", description: "Discover a thoughtful collection of literature, modern fiction, children's books, and inspiring ideas.", primaryButton: "Explore books", secondaryButton: "Browse categories", imageUrl: "", imagePublicId: "" };
